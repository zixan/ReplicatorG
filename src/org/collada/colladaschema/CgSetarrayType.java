...
@XmlType(name = "cg_setarray_type", propOrder = {
    "fixed1X4SAndFloat4X3SAndInt3X3S"
})
public class CgSetarrayType {
    ...
    /**
     * Gets the value of the fixed1X4SAndFloat4X3SAndInt3X3S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fixed1X4SAndFloat4X3SAndInt3X3S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFixed1X4sAndFloat4X3sAndInt3X3s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<JAXBElement<?>> getFixed1X4sAndFloat4X3sAndInt3X3s() {
        if (fixed1X4SAndFloat4X3SAndInt3X3S == null) {
            fixed1X4SAndFloat4X3SAndInt3X3S = new ArrayList<JAXBElement<?>>();
        }
