...
public class ProfileCG {
    ...
    @XmlType(name = "", propOrder = {
        ...
        "annotates",
        "codesAndIncludes",
        "newparamsAndImagesAndSetparams",
        "pass",
        "extras"
    })
    public static class Technique {
        ...
        /**
         * Gets the value of the newparamsAndImagesAndSetparams property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the newparamsAndImagesAndSetparams property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getNewparamsAndImagesAndSetparams().add(newItem);
         * </pre>
         * 
         * 
         * <p>
        ...
        @XmlType(name = "", propOrder = {
            ...
            "stencilClears",
            "draw",
            "projectionMatrixesAndStencilOpSeparatesAndLightSpotDirections",
            "extras"
        })
        public static class Pass {
            ...
            /**
             * Gets the value of the projectionMatrixesAndStencilOpSeparatesAndLightSpotDirections property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the projectionMatrixesAndStencilOpSeparatesAndLightSpotDirections property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getProjectionMatrixesAndStencilOpSeparatesAndLightSpotDirections().add(newItem);
             * </pre>
             * 
             * 
             * <p>
