...
public class ProfileGLES {
    ...
    public static class Technique {
        ...
        @XmlType(name = "", propOrder = {
            ...
            "stencilClear",
            "draw",
            "lightSpotCutofvesAndDepthTestEnablesAndPointSizes",
            "extras"
        })
        public static class Pass {
            ...
            /**
             * Gets the value of the lightSpotCutofvesAndDepthTestEnablesAndPointSizes property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the lightSpotCutofvesAndDepthTestEnablesAndPointSizes property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getLightSpotCutofvesAndDepthTestEnablesAndPointSizes().add(newItem);
             * </pre>
             * 
             * 
             * <p>
