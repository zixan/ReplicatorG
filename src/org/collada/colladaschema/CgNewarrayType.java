...
public class CgNewarrayType {
    ...
    protected List<JAXBElement<?>> fixed1SAndHalf3X3SAndBool3X2S;
    @XmlAttribute(required = true)
    protected BigInteger length;

    /**
     * Gets the value of the fixed1SAndHalf3X3SAndBool3X2S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fixed1SAndHalf3X3SAndBool3X2S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFixed1sAndHalf3X3sAndBool3X2s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
