...
@XmlType(name = "cg_setuser_type", propOrder = {
    "setparams",
    "sampler1DsAndHalf4X1SAndHalf4S"
})
public class CgSetuserType {
    ...
    /**
     * Gets the value of the sampler1DsAndHalf4X1SAndHalf4S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sampler1DsAndHalf4X1SAndHalf4S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSampler1DsAndHalf4X1sAndHalf4s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
