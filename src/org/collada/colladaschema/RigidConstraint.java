...
public class RigidConstraint {
    ...
    public static class Attachment {
         ...
         * 									Gets the value of the rotatesAndExtrasAndTranslates property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the rotatesAndExtrasAndTranslates property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getRotatesAndExtrasAndTranslates().add(newItem);
         * </pre>
         * 
         * 
         * <p>
    ...
    public static class RefAttachment {
         ...
         * 
         * 									The extra element may appear any number of times.
         * 									Gets the value of the extrasAndTranslatesAndRotates property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the extrasAndTranslatesAndRotates property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getExtrasAndTranslatesAndRotates().add(newItem);
         * </pre>
         * 
         * 
         * <p>
